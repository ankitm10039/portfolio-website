          ...
          >
            ...
            >
              ...
              <motion.img 
                ...
                style={{ width: '120px', height: '120px', marginBottom: '1rem', filter: 'drop-shadow(0 10px 20px rgba(0,242,254,0.3))' }}
              />

              <Typography variant="h3" sx={{ fontWeight: 800, color: '#fff', mb: 3, minHeight: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Typewriter
              ...
              <Typography variant="body1" sx={{ color: 'rgba(255,255,255,0.7)', mb: 5, fontSize: '1.2rem', lineHeight: 1.6 }}>
